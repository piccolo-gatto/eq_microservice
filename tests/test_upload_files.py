...
class TestUploadFiles():
    ...
    def test_get_ivent_by_token(self):
        ...
        token = logic.generate_token()
        db = SessionLocal()
        logic.create_ivent(db, datetime_start=datetime_start, datetime_end=datetime_end, token=token)
    ...
    def test_api_upload_file(self):
        URL = "/upload_file?email=ekaterina@gmail.com&type=roti&datetime_start=2023-11-12 04:11:47&datetime_end=2023-11-12 04:15:36"
